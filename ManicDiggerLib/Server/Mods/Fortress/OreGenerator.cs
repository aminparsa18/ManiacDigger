...
public class OreGenerator : IMod
{
    ...
    private void MakeCaves(int x, int y, int z, int chunksize, Random rnd,
                   bool enableCaves,
                   int gravelLength,
                   int goldOreLength,
                   int ironOreLength,
    ...
    private void MakeCuboid(int x, int y, int z, int sizex, int sizey, int sizez, int blocktype, int[] allowin, double chance, Random rnd)
    {
